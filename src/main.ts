...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    UserTrackingService,
    provideAppCheck(() => initializeAppCheck(undefined, { provider: new ReCaptchaEnterpriseProvider('6Lc3hfkqAAAAAD6P8tR0RUtwddEQoAVBiBQ4AN22'), isTokenAutoRefreshEnabled: true })),
