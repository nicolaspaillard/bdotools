...
bootstrapApplication(AppComponent, {
  providers: [
    ...
    UserTrackingService,
    provideAppCheck(() => initializeAppCheck(undefined, { provider: new ReCaptchaEnterpriseProvider('6Lc3hfkqAAAAACmpxoBCfEkhp1MSgjZJJmAwKQyd'), isTokenAutoRefreshEnabled: true })),
